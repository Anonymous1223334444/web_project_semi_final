...
if (isset($_SESSION['email']) && isset($_SESSION['prenom']) && $_SESSION["role"] === "apprenant") {
    ...
    ?>
    <h2 class="cards-title">Because you have watched: <span style="color: #4158D0;">100 days of code</span> this is our selection for you</h2>
                    ...
                    while ($row2 = $result2->fetch_assoc()) {
                        ...
                        <div class="card"
                            ...
                            <div class="title">
                                ...
                                <div>
                                    <p style="background-color: var(--white); color: var(--black);" class="price">$<?= $row["prix"] ?></p>
    ...
    <?php } elseif (isset($_SESSION['email']) && isset($_SESSION['prenom']) && empty($_SESSION["role"])) { 
        ...
        <?php } elseif (isset($_SESSION['email']) && isset($_SESSION['prenom']) && $_SESSION["role"] === "formateur") { 
            ...
            <h1 style="font-family: 'Poppins', sans-serif;
                    ...
                    margin: 35vh 0 0 0;
                    padding-bottom: 35vh"
                    >Pedagogical Designer: <?= $_SESSION['prenom'] . " " . $_SESSION['nom'] . $_SESSION["pp"] ?>
            </h1>
        <?php } else{ 
        ?>
        <section class='hero'>
            <div class='hero_title'>
                ...
                <p>Dive into the most immersive and<br>captivating experience to master new horizons.</p><br><br>
                <p>Enter a universe of endless opportunities,<br>where everything happens with a single click.</p>
                <button id='btn_connect' onclick="window.location.href = 'http://localhost/web_dev_3/pages/Signup.php'">Get Started Now</button>
            </div>
        ...
        <?php
            ...
            $result = $conn->query($sql);
        ?>
        <h2 class="cards-title">The Most Popular Courses</h2>
