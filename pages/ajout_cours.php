    ...
    <div class="container">
        ...
        <form action="action/ajout_cours.php" method="POST" class="max-w-sm mx-auto" enctype="multipart/form-data">
            <div class="space-y-12">
                ...
                <h2 class="text-base font-semibold leading-7 text-gray-900" style="font-size: 2rem; display: flex; justify-content: center; margin-bottom: 2rem;">Add Course</h2>
                <?php
                    if(isset($_GET['error'])) { ?>
                        <p class='error'><?=Validation::clean($_GET['error'])?></p>
                <?php } ?>
                ...
                <?php
                    if(isset($_GET['success'])) { ?>
                        <p class='success'><?=Validation::clean($_GET['success'])?></p>
                <?php } ?>
                <h2 class="text-base font-semibold leading-7 text-gray-900">Enter Course Information</h2>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" name="titre" id="titre" autocomplete="titre" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Course Title">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                            <input type="text" name="categorie" id="categorie" autocomplete="categorie" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Course Category">
                            </div>
                        </div>
                    </div>

                    <div class="sm:col-span-4">
                        <label for="id_formateur" class="block mb-2 text-sm font-medium text-gray-900 white:text-dark">Enter Trainer ID</label>
                    ...
                    <div class="sm:col-span-4">
                        <label for="prix" class="block text-sm font-medium leading-6 text-gray-900">Suggested Price</label>
                        <div class="mt-2">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                            <input type="text" name="prix" id="prix" autocomplete="prix" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Suggested Selling Price">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <p class="mt-3 text-sm leading-6 text-gray-600">Provide the objectives for which this course was created</p>
                    </div>
